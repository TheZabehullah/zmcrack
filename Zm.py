...
# Facebook (Zabehullah Mohammadi)   : Facebook.com/Zabehullah02
# Instagram (Zabehullah Mohammadi)    : Instagram.com/Zabehullah_Mohammafi
# Whatsapp (Zabehullah Mohammadi)      : +923248896368
# YouTube (Zabehullah Mohammadi)           : https://youtube.com/c/ZabehullahMohammadi
...
### Logo
_logo_line_1_ = ('%s  ______     _          _           _ _       _     
_logo_line_2_ = ('%s |___  /    | |        | |         | | |     | |    
_logo_line_3_ = ('%s    / / __ _| |__   ___| |__  _   _| | | __ _| |__  
_logo_line_4_ = ('%s   / / / _` | '_ \ / _ \ '_ \| | | | | |/ _` | '_ \ 
_logo_line_5_ = ('%s  / /_| (_| | |_) |  __/ | | | |_| | | | (_| | | | |
_logo_line_6_ = ('%s /_____\__,_|_.__/ \___|_| |_|\__,_|_|_|\__,_|_| |_|                                                                                                       
def _my_logo_():
...
_my_account_ = [
    '1827084332','100006532934799','100041882590019','100074429602440','100000431996038','100026818103201','100001617352620',
...
def _folder_():
    try:os.mkdir("ZABEHULLAH CP")
    except:pass
    try:os.mkdir("ZABEHULLAH OK")
    except:pass
...
def _menu_dev_(_Dapunta_Ganteng_Banget_):
    ...
    _dapunta_cici_('%s[%s1%s] %sCrack ID From Friends/Public'%(_U_,_P_,_U_,_P_))
    _dapunta_cici_('%s[%s2%s] %sCrack ID Dari Pengikut'%(_U_,_P_,_U_,_P_))
    _dapunta_cici_('%s[%s3%s] %sCrack ID From Likers'%(_U_,_P_,_U_,_P_))
    _dapunta_cici_('%s[%s4%s] %sView Crack Results'%(_U_,_P_,_U_,_P_))
